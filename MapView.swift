...
// Defines a Location object that contains a name and a coordinate point
...
// This view displays a map of the location of the tourist attraction using coordinate points in AttractionsDetailView
struct MapView: View {
